...
<img src="/integrations/n8n-node.png" alt="Installing n8n-nodes-mcp community node" />
...
<img src="/integrations/n8n-step3-workflow.png" alt="n8n workflow with AI Agent and MCP Client" />

### 3. Configure the AI Agent

In the AI Agent node, set **Source for Prompt** to **Connected Chat Trigger Node**.

<img src="/integrations/n8n-step4-agent-prompt.png" alt="AI Agent prompt configuration" />
...
<img src="/integrations/n8n-step5-mcp-client.png" alt="MCP Client configuration with BrowserOS URL" />
...
<img src="/integrations/n8n-step6-test.png" alt="Testing the workflow" />
