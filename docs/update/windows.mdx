...
<Steps>
  ...
  <Step title="Run the installer">
    ...
    <Frame>
      <img src="/update/windows-installation-installer-tmp-folder.png" alt="Temporary folder created by the installer" />
    </Frame>
    ...
    <Frame>
      <img src="/update/windows-installation-app-on-desktop.jpeg" alt="BrowserOS app appears on the desktop after installation" />
    </Frame>
  ...
  <Step title="Allow the BrowserOS Agent">
    ...
    <Frame>
      <img src="/update/windows-installation-allow-browseros-agent.png" alt="Allow BrowserOS Agent network access prompt" />
    </Frame>
